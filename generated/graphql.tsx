...
export type BestCardQuery = (
  { __typename?: 'Query' }
  & { bestSkaters: Array<(
    { __typename?: 'BestSkater' }
    & Pick<BestSkater, 'id' | 'firstName' | 'lastName' | 'teamAbbreviation' | 'points' | 'goals' | 'assists' | 'plusMinus' | 'penaltyMinutes' | 'powerPlayGoals' | 'powerPlayPoints' | 'shortHandedGoals' | 'shortHandedPoints' | 'timeOnIcePerGame' | 'faceOffsTaken' | 'faceOffPct' | 'shots' | 'hits' | 'takeaways' | 'giveaways' | 'blocked'>
  )>, bestGoalies: Array<(
    { __typename?: 'BestGoalie' }
    & Pick<BestGoalie, 'id' | 'firstName' | 'lastName' | 'teamAbbreviation' | 'wins' | 'losses' | 'shutouts' | 'savePct' | 'goalsAgainstAverage' | 'powerPlaySavePct' | 'shortHandedSavePct' | 'powerPlayShotsAgainst' | 'shortHandedShotsAgainst' | 'savesPerGame' | 'shotsAgainstPerGame' | 'winPct' | 'penaltyMinutes' | 'goals' | 'assists'>
  )>, bestTeams: Array<(
    { __typename?: 'BestTeam' }
    & Pick<BestTeam, 'id' | 'teamName' | 'locationName' | 'abbreviation' | 'siteLink' | 'wins' | 'losses' | 'otLosses' | 'awayRecord' | 'homeRecord' | 'goalsFor' | 'goalsAgainst' | 'powerPlayGoals' | 'powerPlayPct' | 'shortHandedTimes' | 'penaltyKillPct' | 'shotsForPerGame' | 'shotsAgainstPerGame' | 'takeaways' | 'giveaways' | 'hitsForPerGame' | 'hitsAgainstPerGame'>
  )> }
);
 ...
 * });
 */
export function useBestCardQuery(baseOptions?: Apollo.QueryHookOptions<BestCardQuery, BestCardQueryVariables>) {
        return Apollo.useQuery<BestCardQuery, BestCardQueryVariables>(BestCardDocument, baseOptions);
      }
export function useBestCardLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BestCardQuery, BestCardQueryVariables>) {
          return Apollo.useLazyQuery<BestCardQuery, BestCardQueryVariables>(BestCardDocument, baseOptions);
        }
export type BestCardQueryHookResult = ReturnType<typeof useBestCardQuery>;
export type BestCardLazyQueryHookResult = ReturnType<typeof useBestCardLazyQuery>;
export type BestCardQueryResult = Apollo.QueryResult<BestCardQuery, BestCardQueryVariables>;
export const BestGoalieDocument = gql`
    query BestGoalie($numOfGames: Int!, $sortBy: StatSortFields!, $take: Int!) {
  bestGoalies(input: {numOfGames: $numOfGames, sortBy: $sortBy, take: $take}) {
    id
    firstName
    lastName
    teamAbbreviation
 ...
 * });
 */
export function useBestGoalieQuery(baseOptions: Apollo.QueryHookOptions<BestGoalieQuery, BestGoalieQueryVariables>) {
        return Apollo.useQuery<BestGoalieQuery, BestGoalieQueryVariables>(BestGoalieDocument, baseOptions);
      }
export function useBestGoalieLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BestGoalieQuery, BestGoalieQueryVariables>) {
          return Apollo.useLazyQuery<BestGoalieQuery, BestGoalieQueryVariables>(BestGoalieDocument, baseOptions);
        }
export type BestGoalieQueryHookResult = ReturnType<typeof useBestGoalieQuery>;
export type BestGoalieLazyQueryHookResult = ReturnType<typeof useBestGoalieLazyQuery>;
export type BestGoalieQueryResult = Apollo.QueryResult<BestGoalieQuery, BestGoalieQueryVariables>;
export const BestSkaterDocument = gql`
    query BestSkater($numOfGames: Int!, $sortBy: StatSortFields!, $take: Int!) {
  bestSkaters(input: {numOfGames: $numOfGames, sortBy: $sortBy, take: $take}) {
    id
    firstName
    lastName
    teamAbbreviation
 ...
 * });
 */
export function useBestSkaterQuery(baseOptions: Apollo.QueryHookOptions<BestSkaterQuery, BestSkaterQueryVariables>) {
        return Apollo.useQuery<BestSkaterQuery, BestSkaterQueryVariables>(BestSkaterDocument, baseOptions);
      }
export function useBestSkaterLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BestSkaterQuery, BestSkaterQueryVariables>) {
          return Apollo.useLazyQuery<BestSkaterQuery, BestSkaterQueryVariables>(BestSkaterDocument, baseOptions);
        }
export type BestSkaterQueryHookResult = ReturnType<typeof useBestSkaterQuery>;
export type BestSkaterLazyQueryHookResult = ReturnType<typeof useBestSkaterLazyQuery>;
export type BestSkaterQueryResult = Apollo.QueryResult<BestSkaterQuery, BestSkaterQueryVariables>;
export const BestTeamDocument = gql`
    query BestTeam($numOfGames: Int!, $sortBy: StatSortFields!, $take: Int!) {
  bestTeams(input: {numOfGames: $numOfGames, sortBy: $sortBy, take: $take}) {
    id
    teamName
    locationName
    abbreviation
 ...
 * });
 */
export function useBestTeamQuery(baseOptions: Apollo.QueryHookOptions<BestTeamQuery, BestTeamQueryVariables>) {
        return Apollo.useQuery<BestTeamQuery, BestTeamQueryVariables>(BestTeamDocument, baseOptions);
      }
export function useBestTeamLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BestTeamQuery, BestTeamQueryVariables>) {
          return Apollo.useLazyQuery<BestTeamQuery, BestTeamQueryVariables>(BestTeamDocument, baseOptions);
        }
export type BestTeamQueryHookResult = ReturnType<typeof useBestTeamQuery>;
export type BestTeamLazyQueryHookResult = ReturnType<typeof useBestTeamLazyQuery>;
export type BestTeamQueryResult = Apollo.QueryResult<BestTeamQuery, BestTeamQueryVariables>;